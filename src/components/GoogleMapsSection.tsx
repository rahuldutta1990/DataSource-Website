...
export const OFFICE_LOCATIONS: OfficeLocation[] = [
  {
    id: 'kolkata',
    name: 'Kolkata Technology Hub & Consultation Office',
    badge: 'Principal Technology Hub & Consultation Office',
    ...
    focus: [
      'Enterprise IT Consulting & Problem Solving',
      'Data Analytics & Power BI Dashboards',
      'Full-Stack Software & Cloud Engineering',
      'ETL Pipelines & Pragmatic AI Solutions',
    ],
    mapQuery:
      '3B13, Flat: 5D, Sanhita Simoco Township, Satuli, Langal Benki, Bhaganpur, Kashipur, Pithapukur, Bhangar, PO&PS: Hatisala Near Hatisala Six Lane, New Town Action 3, Kolkata 700135, West Bengal, India',

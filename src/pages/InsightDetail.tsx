    ...
    <div className="min-h-screen bg-[#FAFCFF]">
      ...
      <div className="bg-white border-b border-slate-100 py-3.5 px-4">
        <div className="max-w-4xl mx-auto flex items-center gap-2 text-xs text-slate-500">
          ...
          <Link to="/insights" className="hover:text-[#0077FF]">Insights</Link>
          <ChevronRight className="w-3 h-3" />
      ...
      <article className="pt-12 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between border-y border-slate-200 py-4 text-xs text-slate-500">
              ...
              <button
                onClick={handleShare}
                className="inline-flex items-center gap-1.5 text-[#0077FF] font-bold hover:underline"
              >
            ...
            {/* Featured Image */}
            <div className="rounded-3xl overflow-hidden aspect-[16/9] shadow-lg bg-slate-100">
              <img src={post.coverImage} alt={post.title} className="w-full h-full object-cover" />
            </div>

            {/* Content Body */}
            <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/90 shadow-sm">
              <div className="prose prose-slate max-w-none text-slate-700 leading-relaxed font-body whitespace-pre-line text-base sm:text-lg">
                {post.content}
              </div>
            ...
            <div className="bg-[#0B1B2B] rounded-3xl p-8 sm:p-10 text-white flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>

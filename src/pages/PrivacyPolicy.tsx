...
export const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#FAFCFF] py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/90 shadow-sm space-y-6">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#0B1B2B] font-heading">
            Privacy Policy
          </h1>
          <p className="text-xs text-slate-400">Effective Date: January 1, 2026</p>

          <div className="prose prose-slate max-w-none text-slate-700 leading-relaxed font-body space-y-4 pt-4 border-t border-slate-100">
            <h2 className="text-xl font-bold text-slate-900 font-heading">1. Commitment to Privacy</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 font-heading">3. How Information Is Used</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 font-heading">4. Confidentiality &amp; NDAs</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 font-heading">5. Contact Us</h2>
            <p>
              For questions regarding our privacy practices, please contact us at{' '}
              <a href="mailto:privacy@datasource.tech" className="text-[#0077FF] font-semibold underline">

    ...
    <div className="min-h-screen bg-[#FAFCFF]">
      ...
      <div className="bg-white border-b border-slate-100 py-3.5 px-4">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs text-slate-500">
          ...
          <Link to="/case-studies" className="hover:text-[#0077FF]">Case Studies</Link>
          <ChevronRight className="w-3 h-3" />
          <span className="text-slate-900 font-semibold truncate">{caseStudy.title}</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl space-y-5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-slate-500 font-bold">• {caseStudy.year}</span>
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0B1B2B] font-heading leading-tight">
              {caseStudy.title}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-10">
              {/* Cover Image */}
              <div className="rounded-3xl overflow-hidden aspect-[16/9] shadow-lg bg-slate-200">
                <img
              ...
              {/* Challenge */}
              <div className="bg-white rounded-2xl p-8 border border-slate-200/90 shadow-sm space-y-4">
                <span className="text-xs font-bold uppercase tracking-wider text-rose-600">
                  Phase 1 • The Problem
                </span>
                <h2 className="text-2xl font-bold text-[#0B1B2B] font-heading">The Challenge</h2>
                <p className="text-slate-700 leading-relaxed font-body text-base sm:text-lg">
                  {caseStudy.challenge}
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-200/90 shadow-sm space-y-4">
                ...
                <h2 className="text-2xl font-bold text-[#0B1B2B] font-heading">The DataSource Solution</h2>
                <p className="text-slate-700 leading-relaxed font-body text-base sm:text-lg">
                  {caseStudy.solution}
                </p>
                {caseStudy.implementationDetails && (
                  <div className="mt-4 p-4 rounded-xl bg-slate-50 border border-slate-200 text-sm text-slate-600">
                    <span className="font-bold text-slate-800 block mb-1">Implementation Note:</span>
                    {caseStudy.implementationDetails}
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-200/90 shadow-sm space-y-6">
                ...
                <h2 className="text-2xl font-bold text-[#0B1B2B] font-heading">Outcomes &amp; Impact</h2>
                <p className="text-slate-700 leading-relaxed font-body text-base sm:text-lg">
                  {caseStudy.result}
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                  {caseStudy.metrics.map((m, i) => (
                    <div key={i} className="p-5 rounded-xl bg-slate-50 border border-slate-200 text-center">
                      <div className="text-2xl font-black text-[#0077FF] font-heading">{m.value}</div>
                      <div className="text-xs text-slate-600 mt-1 font-semibold">{m.label}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {caseStudy.testimonialQuote && (
                <div className="bg-[#0B1B2B] text-white rounded-2xl p-8 space-y-4 relative">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-sm space-y-4">
                <h3 className="text-base font-bold text-slate-900 font-heading">Technologies Applied</h3>
                <div className="flex flex-wrap gap-2">
                  {caseStudy.technologies.map((t, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 rounded-lg bg-slate-100 text-slate-800 text-xs font-mono font-semibold"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-sm space-y-4">
                <h3 className="text-base font-bold text-slate-900 font-heading">Solve Similar Bottlenecks</h3>

      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4">
        <div className="bg-slate-900 border border-slate-800 py-8 px-6 shadow-2xl rounded-3xl sm:px-10">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mb-5 bg-white hover:bg-slate-100 text-slate-800 py-3 rounded-xl font-bold text-sm shadow flex items-center justify-center gap-3 transition-colors active:scale-98"
          >
          ...
          <div className="relative flex py-2 items-center mb-5">
            ...
            <span className="flex-shrink mx-3 text-slate-500 text-xs font-semibold uppercase">Or with credentials</span>
            <div className="flex-grow border-t border-slate-800"></div>
          </div>

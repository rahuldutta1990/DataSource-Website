      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/90 shadow-sm space-y-6">
          ...
          <div className="prose prose-slate max-w-none text-slate-700 leading-relaxed font-body space-y-4 pt-4 border-t border-slate-100">
            ...
            <h2 className="text-xl font-bold text-slate-900 font-heading">2. Professional Services Engagements</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 font-heading">3. Intellectual Property Rights</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 font-heading">4. Contact Information</h2>
            <p>
              For legal inquiries, contact{' '}
              <a href="mailto:legal@datasource.tech" className="text-[#0077FF] font-semibold underline">
